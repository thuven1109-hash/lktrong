...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onStart, onToggleSidebar, userProfiles }) => {
  ...
  const AVATAR_OPTIONS = [
    "https://lh3.googleusercontent.com/u/0/d/1yf36GOu0NhCA6h1OGoSCORQ4ho71kEcx"
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onStart({
      ...
      age: 20,
      background: "Vốn là con gái rượu nổi danh xinh đẹp tuyệt trần, nết na, đoan trang đài các của ông Cai tổng vùng Định Yên. Từng có một hôn ước vô cùng danh giá với con trai vị quan lớn trên tỉnh. Nhưng hiện tại mang danh \"gái hư thân thất nết\", \"ăn cơm trước kẻng\", phải lủi thủi gả chui vào phủ Hội đồng Lương qua cửa sau. Bị mẹ chồng (Bà Hội đồng) căm ghét tột độ, đày đọa vì đã làm dâu 3 năm nhưng vẫn chưa sinh được con."
    }, selectedAvatar);
  };
