...
3. QUY TẮC NHẢ MANH MỐI (THE 1% CLUE RULE): Bí mật là thứ bị chôn vùi. Người dùng phải tương tác, trò chuyện và đào sâu trong một thời gian RẤT DÀI mới có cơ hội chạm tới.
...
4. CƠ CHẾ ĐÁP TRẢ (REACTION MECHANISM)
